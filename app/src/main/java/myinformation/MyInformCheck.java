...
public class MyInformCheck extends AppCompatActivity {
    TextView tv_mydogage, tv_mydogsize, tv_mydogspecies, tv_baddog;
    Button btn_edit , btn_see;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_inform_check);
                    ...
                    public void onResponse(String response) {
                        ...
                        try
                        {
                            ...
                            if (success)
                            {
                                ...
                                Toast.makeText(getApplicationContext(), "내 반려견 정보 가져오기 성공", Toast.LENGTH_LONG).show();
                            ...
                            {    //내정보 조회 실패
                                Toast.makeText(getApplicationContext(), "내 반려견 정보 확인 실패 ", Toast.LENGTH_LONG).show();
                                return;
                            }
